...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        '--task',
        choices=['foundation', 'flood', 'foundation_xdxd_sn5', 'foundation_cannab_sn5', 'foundation_selimsef_xview2', 'foundation_selimsef_sn4'],
        required=True
    )
    parser.add_argument(
        '--exp_id',
...
def get_default_cfg_path(task: str) -> str:
    ...
    elif task == 'foundation_cannab_sn5':
        return 'configs/defaults/foundation_cannab_sn5.yaml'
    elif task == 'foundation_selimsef_xview2':
        return 'configs/defaults/foundation_selimsef_xview2.yaml'
    elif task == 'foundation_selimsef_sn4':
        return 'configs/defaults/foundation_selimsef_sn4.yaml'
    else:
