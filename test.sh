...
python tools/building/postproc_building.py --foundation /wdata/ensembled_preds/$FOUNDATION_DIR --flood /wdata/ensembled_preds/$FLOOD_DIR

python tools/road/vectorize.py --foundation /wdata/ensembled_preds/$FOUNDATION_DIR
